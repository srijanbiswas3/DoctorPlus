...
public class Recommend2 extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    TextView name, check;
    Toolbar toolbar;
    Button next;
    String result=" ";
...
*/
    ...
    //        tips.setText(one);
      ...
      //      tips.setText(six);
        ...
        CheckBox[] dynamicCheckBoxes = new CheckBox[n];
        for (int i = 0; i < n; i++) {
            CheckBox cb = new CheckBox(getApplicationContext());
            cb.setTextSize(17);
            cb.setTextColor(getColor(R.color.background));
          //  cb.setTypeface(Typeface.DEFAULT);
           // cb.setButtonDrawable(R.drawable.cancel);
            cb.setHighlightColor(getColor(R.color.background));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("id", id);
                i.putStringArrayListExtra("list",checked);
